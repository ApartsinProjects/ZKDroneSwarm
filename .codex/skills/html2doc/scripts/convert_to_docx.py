...
try:
    ...
    print("Install it with: pip install -r .codex/skills/html2doc/requirements.txt")
...
def ensure_pandoc_available():
    """Fail early with a clear message when Pandoc is unavailable."""
    try:
        return pypandoc.get_pandoc_path()
    except (OSError, RuntimeError) as exc:
        print("Missing dependency: pandoc executable")
        print(
            "Install Pandoc on your system or run "
...
def main():
    ...
    print(f"\nNext step: {sys.executable} scripts/apply_academic_style.py")
