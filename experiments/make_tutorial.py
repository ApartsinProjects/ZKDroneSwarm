...
A("<div class='formal'><h4>No-structure class (each (drone,target) is its own unknown)</h4>"
  ...
  "constant, so it cannot rank the unseen, the floor of Theorem 1.</p>"
...
A("<div class='formal'><h4>Memory-based and additive</h4>"
  ...
  "shared popularity order, which cannot personalize (Theorem 5).</p></div>")
...
A("<p><b>Takeaway (three honest findings from the numbers).</b></p>"
  ...
  "not preferences, become the bottleneck and everyone collapses toward the matching floor. Honest "
  "conclusion: without coordination, severe contention erases the advantage, and explicit "
  "de-confliction is the natural next ingredient.</li>"
