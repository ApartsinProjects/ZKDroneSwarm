...
| 43 | ChoiceEM (choice-informativeness joint EM) | results/pilots/choiceem8_20260523_083153.json | unseen+anytime for RewardCF/ChoiceCF/ChoiceEM x sigma_obs{0.3,0.6,1.0}; HONEST NEGATIVE: ChoiceEM (0.01) < ChoiceCF (0.09) < RewardCF; EM cold-start deadlock + choice channel weaker than rewards; -> docs/CHOICEEM.md | 8 | 2026-05-23 |
