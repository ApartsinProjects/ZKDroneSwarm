...
This document provides a formal specification of the Zero-Knowledge Multi-Robot Task Allocation (ZK-MRTA) problem, defining the system model, informational constraints, and performance objectives that govern decentralized multi-agent task allocation under hidden compatibility structures.
...
## 4. Sequential Interaction Model
...
### 5.2 Agent Resource Constraints
...
## 8. Hidden Environment Structure
...
## 9. Objective and Performance Metrics
...
Performance metrics defined in §9 are computed identically for all strategies, enabling direct comparison under identical conditions.

---

## 11. Input–Output Formalization
...
## 13. Formal Definition of ZK-MRTA
...
The problem is subject to the Zero-Knowledge constraints defined in §2: agents have no prior knowledge of tasks or their own capabilities, cannot communicate, and must rely solely on $O$ at each step.
