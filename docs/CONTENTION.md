...
|---|---|---|---|---|
| **ContentionAdaCF** | 0.252 [0.219, 0.286] | 0.205 [0.186, 0.223] | 0.153 [0.132, 0.173] | 0.100 [0.086, 0.113] |
| **ContentionCF** | 0.314 [0.290, 0.337] | 0.178 [0.160, 0.200] | 0.134 [0.115, 0.155] | 0.105 [0.096, 0.114] |
| **ActiveCFconv** | 0.439 [0.412, 0.464] | 0.230 [0.206, 0.252] | 0.125 [0.109, 0.145] | 0.046 [0.022, 0.070] |
| **RewardCFconv** | 0.439 [0.419, 0.462] | 0.199 [0.186, 0.214] | 0.121 [0.102, 0.138] | 0.059 [0.044, 0.078] |
| PTF | 0.243 [0.223, 0.260] | 0.151 [0.136, 0.168] | 0.096 [0.083, 0.111] | 0.057 [0.040, 0.075] |
| UCBIndep | 0.005 [-0.003, 0.014] | -0.002 [-0.009, 0.005] | -0.002 [-0.009, 0.006] | 0.004 [-0.005, 0.013] |
| Random | -0.010 [-0.023, -0.000] | 0.002 [-0.010, 0.014] | -0.003 [-0.010, 0.005] | -0.010 [-0.027, 0.007] |

## Categorical: unseen-pair skill (learned under contention, eval contention-free)

| method | pool=240 | pool=60 | pool=30 | pool=15 |
|---|---|---|---|---|
| **ContentionAdaCF** | 0.079 [0.055, 0.103] | 0.302 [0.283, 0.323] | 0.352 [0.325, 0.382] | 0.295 [0.260, 0.325] |
| **ContentionCF** | 0.023 [0.002, 0.048] | 0.290 [0.267, 0.313] | 0.312 [0.270, 0.345] | 0.273 [0.233, 0.311] |
| **ActiveCFconv** | 0.113 [0.079, 0.145] | 0.350 [0.320, 0.384] | 0.310 [0.288, 0.330] | 0.195 [0.166, 0.221] |
| **RewardCFconv** | 0.323 [0.291, 0.362] | 0.383 [0.352, 0.414] | 0.339 [0.314, 0.367] | 0.287 [0.242, 0.325] |
| PTF | 0.343 [0.333, 0.356] | 0.338 [0.302, 0.373] | 0.262 [0.232, 0.293] | 0.141 [0.114, 0.169] |
| UCBIndep | -0.007 [-0.014, -0.000] | 0.001 [-0.007, 0.005] | -0.003 [-0.009, 0.002] | -0.006 [-0.015, 0.003] |
| Random | -0.007 [-0.027, 0.014] | 0.014 [-0.002, 0.031] | -0.009 [-0.027, 0.009] | -0.005 [-0.027, 0.019] |

## Collision rate (fraction of engagements lost to contention)

| method | pool=240 | pool=60 | pool=30 | pool=15 |
|---|---|---|---|---|
| ContentionAdaCF | 0.495 | 0.392 | 0.465 | 0.581 |
