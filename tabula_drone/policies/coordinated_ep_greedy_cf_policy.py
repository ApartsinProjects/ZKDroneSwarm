...
class CoordinatedEpGreedyCFPolicy:
    """
    ...
    def __init__(
        ...
        """
        Initialize coordinated CF policy for a single agent.
        ...
        # other_agents_lv: This agent's estimates of other agents' latent vectors
        # Needed to learn from others' observed rewards and for coordinated selection
